...
- [ ] **Phase 76: Gate Primitive Exposure** - Expose H, Z, Ry gates at Python level via Cython bindings
...
- [ ] 76-02-PLAN.md - branch() method on qint/qbool
- [ ] 76-03-PLAN.md - Qiskit verification tests
