...
- [x] **DEBT-01**: Remove dead QPU.c/QPU.h stubs and all references across C/Cython/Python layers
- [x] **DEBT-02**: Automate qint_preprocessed.pyx generation with build-time sync and CI drift check
