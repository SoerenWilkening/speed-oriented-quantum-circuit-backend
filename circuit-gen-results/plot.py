...
plt.tight_layout(pad = 0.15, h_pad=0.2, w_pad=0.0)
plt.savefig("time_circuit_generation2.pdf")
plt.show()
...
plt.tight_layout(pad = 0.15, h_pad=0.2, w_pad=0.0)
plt.savefig("memory_circuit_generation2.pdf")
plt.show()
