/**
 * @file toffoli_cdkm_adder.c
 * @brief Dynamic CDKM ripple-carry adder/subtractor helpers.
 *
 * Split from toffoli_multiplication.c to stay under the 500-line limit.
 * Provides the inline CDKM adder building blocks (MAJ/UMA primitives,
 * QQ add/sub, CQ add, controlled variants) used by multiplication,
 * division, and modular reduction modules.
 *
 * References:
